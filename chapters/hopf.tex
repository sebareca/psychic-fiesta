...
En esta \myworries{sección} nos vamos a concentrar en ejemplos de espacios vectoriales trenzados que provengan de módulos
de Yetter-Drinfeld.
...
\begin{example} \label{exampletensoralgebra}
	...
	\]
	La existencia de la antípoda se puede encontrar en \myworries{REFERENCIA}.
\end{example}
